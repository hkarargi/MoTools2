...
public class HussmeksBagItem extends MoToolsModElements.ModElement {
	@ObjectHolder("mo_tools:hussmeks_bag")
	public static final Item block = null;
	public HussmeksBagItem(MoToolsModElements instance) {
		super(instance, 52);
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Hussmek's Bag");
					}
