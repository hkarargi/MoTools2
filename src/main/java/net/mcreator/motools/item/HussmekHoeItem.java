...
public class HussmekHoeItem extends MoToolsModElements.ModElement {
	@ObjectHolder("mo_tools:hussmek_hoe")
	public static final Item block = null;
	public HussmekHoeItem(MoToolsModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		}, -1f, new Item.Properties().group(HussmekTabItemGroup.tab)) {
		}.setRegistryName("hussmek_hoe"));
	}
}
