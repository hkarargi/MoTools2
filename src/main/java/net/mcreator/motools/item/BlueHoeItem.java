...
public class BlueHoeItem extends MoToolsModElements.ModElement {
	@ObjectHolder("mo_tools:blue_hoe")
	public static final Item block = null;
	public BlueHoeItem(MoToolsModElements instance) {
		super(instance, 15);
	}
	...
	public void initElements() {
		...
		}, -2f, new Item.Properties().group(HussmekTabItemGroup.tab)) {
		}.setRegistryName("blue_hoe"));
	}
}
