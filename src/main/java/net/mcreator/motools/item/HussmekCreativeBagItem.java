...
import net.mcreator.motools.gui.FoodGUIGui;
...
public class HussmekCreativeBagItem extends MoToolsModElements.ModElement {
	@ObjectHolder("mo_tools:hussmek_creative_bag")
	public static final Item block = null;
	public HussmekCreativeBagItem(MoToolsModElements instance) {
		super(instance, 51);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof FoodGUIGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hussmek_creative_bag");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This is a magic hat that gives food"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Hussmek Creative Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new FoodGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
